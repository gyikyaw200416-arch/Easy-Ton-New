...
function App() {
  ...
  const [spinRotation, setSpinRotation] = useState(0); // For wheel rotation animation
  ...
  const handleSpin = async () => {
    ...
    // Rotate multiple times + specific degrees to land on the color (calculated from top)
